...
to UTC `Z`" is now **realized** by this shipment; the two new learnings capture
the durable technique. The Copilot review-loop learning is *reinforced*, not
superseded. No deletions or archival needed.

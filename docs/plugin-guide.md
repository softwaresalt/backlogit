...
For standalone binary installs, see [Installation](installation.md#which-installation-path).
...
| [`.github/skills/`](../.github/skills/) | Autoharness-generated repo harness | Workspace-tailored skills written by Autoharness install or tune, with `Generated by autoharness` footers |

...
- Shipment `095-S` (feature `107-F` plus twelve tasks `107.001-T`–`107.012-T`, thirteen items total) matches the plan's task map, with backfills, the `107.010-T` RED integration regression, the `107.009-T` codec change (depending on `107.010-T`), the `107.011-T` schema opening (depending on `107.010-T`), and the `107.012-T` guide rewrite (depending on `107.009-T` + `107.011-T`) sequenced after the `107.001-T` RED observation.

...
- **Fix**: guard added. Session memory: `docs/archive/memory/2026-07-10/backlogit-update-command-halt-memory.md`.
...
- **Session memory**: `docs/archive/memory/2026-07-12/plugin-install-path-fix-memory.md`,
  `docs/archive/memory/2026-07-12/windows-plugin-subdir-failure-memory.md`.
...
- **Session memory**: `docs/archive/memory/2026-07-13/` files.
...
- **Session memory**: `docs/archive/memory/2026-07-17/` files.
...
- **Session memory**: `docs/archive/memory/2026-07-18/` files.
...
- **Session memory**: `docs/archive/memory/2026-07-19-ship-099-S-*.md`.
...
- **Session memory**: `docs/archive/memory/2026-07-20-*.md`.
...
- **Session memory**: `docs/archive/memory/2026-07-21/117-F-group-a-drain-memory.md`.

---

## 2026-07-22 — 118-F P1 Index Bundle + 8CD8F46A Plan-Review Dispatch Decision

- **118-F P1**: index bundle work. Session memory: `docs/archive/memory/2026-07-22/118-F-p1-index-bundle-memory.md`.
- **8CD8F46A / Decision artifact 8CD8F46A** (decision `docs/decisions/2026-07-22-plan-review-dispatch-capability-deliberation.md`):
  ...
  - Follow-ups: stash 6FA0829B (upstream plan-review/SKILL.md.tmpl template parity),
    stash 4CECCEAA (end-to-end Stage/harvest enforcement — harvested into 119-F / 102-S).
    Stash 7F0A6E89 is the separate upstream spike/SKILL.md.tmpl template update (still active).
...
- **Session memory**: `docs/archive/memory/2026-07-22/8CD8F46A-plan-review-dispatch-memory.md` (archived during compaction).
...
- **Stash 7F0A6E89**: upstream `spike/SKILL.md.tmpl` template update (active, NOT absorbed by 102-S; separate from 6FA0829B).

...
* Use grep and glob tools to search the codebase for patterns, symbols, and file references related to research targets.
  * Use glob to discover files by name or extension pattern.
  * Use grep to search file contents for specific symbols, function names, or patterns.
  * Read relevant files directly when specific paths are known.

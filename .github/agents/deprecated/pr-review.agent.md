...
> **⚠️ DEPRECATED (F015):** The pr-review agent is superseded by the [Ship agent](.github/agents/ship.agent.md) which uses the modular pr-lifecycle skill. The agent remains functional but points to legacy control flow. Prefer the Ship agent for new work.

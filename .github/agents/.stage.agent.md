...
1. Read the plan's `## Plan Review` section. If the section is absent: **HALT** — treat
   as a missing review record; `skip_review: true` cannot override an absent section.

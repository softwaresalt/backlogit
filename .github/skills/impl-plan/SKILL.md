...
simpler alternative you rejected. Reserve documented deviations for SHOULD-level
principles, which the constitution accepts with rationale. Revise a plan that
conflicts with a MUST-level principle before review — the constitution expects
self-correction, not a documented pass-through. A NON-NEGOTIABLE principle
cannot be deviated from at all: a genuine conflict halts the plan under P-005.

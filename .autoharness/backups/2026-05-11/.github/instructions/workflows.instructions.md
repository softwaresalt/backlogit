---
description: "Required instructions for GitHub Actions workflow files in backlogit repository"
...
These instructions define required conventions and security requirements for GitHub Actions workflows in the backlogit repository. All workflows MUST comply with these rules to pass CI validation.
...
Workflows MUST run on GitHub-hosted Ubuntu runners. Other runner types are not supported in backlogit.

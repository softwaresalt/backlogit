...
Generated by autoharness | Constitution version: 1.1.0

---

## Repository Operating Model

backlogit uses a two-agent pipeline model:
- **Stage agent**: Stash-to-backlog pipeline (triage, deliberate, plan, review, harvest)
